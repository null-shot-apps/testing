        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Premium streetwear and casual fashion for the modern lifestyle. 
              Elevate your style with our curated collection of luxury clothing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/streetwear" className="text-gray-400 hover:text-white transition-colors">Streetwear</Link></li>
